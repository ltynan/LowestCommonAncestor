...
public class DAGTest {
	...
	public void testLowestCommonAncestor() {
		...
		assertEquals("nodes(nodes9,nodes8) = 6", nodes.get(6), DAG.lowestCommonAncestor(nodes.get(9), nodes.get(8)));
		assertEquals("nodes(nodes8,nodes4) = 2", nodes.get(2), DAG.lowestCommonAncestor(nodes.get(8), nodes.get(4)));
		assertEquals("nodes(nodes8,nodes3) = 0", nodes.get(0), DAG.lowestCommonAncestor(nodes.get(8), nodes.get(3)));
